...
public class ReactRole extends ListenerAdapter {
	...
	public void onMessageReactionAdd(MessageReactionAddEvent e) { 
		if (e.getMessageId().equals("602256968094318593") && e.getReactionEmote().getName().equals("🗒")) { //add changelog
		...
		if (e.getMessageId().equals("602256968094318593") && e.getReactionEmote().getName().equals("🎊")) { //add events
	...
	public void onMessageReactionRemove(MessageReactionRemoveEvent e) { //rev changelog
		if (e.getMessageId().equals("602256968094318593") && e.getReactionEmote().getName().equals("🗒")) { 
